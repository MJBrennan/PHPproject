...
class jweather {
    ...
    private function show() {
        ...
        $condition_text = array("Tornado", " tropical storm", "hurricane", "severe storms", "Thunderstorms", "Rain and snow mixed", "Rain and hail", "Snow mixed with sleet", "Freezing drizzle", "drizzle", "cold rain", "Raining", "Raining", "snowflakes", "Rain and Snow", " Snow with wind", "snow", "hail", "frost", "sandstorm", "Misty", "Smog", "Smoked", "Wind direction", "Whirlwind", "Cold", "Cloudy", "Cloudy (night)", "cloudy (day)", "Partly cloudy (night)", "Partly cloudy (day)", "Clear (night)", "Sunny", "Very clear (night)", "Very light (day)", "Rain and hail mixed", "Hot", "Sunny", "Cloudy", "Fair", "Partly Cloudy", "Heavy Snow", "Scattered periods of snow", "heavy snow", "Fair ", "drizzle", "Rain and snow", "Partly Cloudy", 3200 => "Current Weather");
		...
		$html .= '<div class="jweatherWind">Wind: '. $wd .' '. $feed->wind->speed .' '. $feed->units->speed .'</div>';
		$html .= '<div class="jweatherLink"><a target="_blank" href="'. $feed->item->link .'">Complete Weather</a></div>';
		$html .= '</div>';
		$html .= '</div>';
