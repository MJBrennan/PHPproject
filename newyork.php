        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="page-header">
			   ...
			   <center>
                <img src="images/newyork.jpg" class="img-rounded" width="800" height="200">
		       </center>
            </div>
            </div>
          </div>
      ...
      <div class="bs-docs-section">
        <div class="row">
          <div class="col-lg-12">
            <div class="page-header">
			<center>
              <h1 id="type"> New York Information</h1>
			  </center>
            </div>
          </div>
        </div>
...
new jweather('USNY0996','c','img/',false);
...
echo getFeed("http://rss.nytimes.com/services/xml/rss/nyt/HomePage.xml");	
