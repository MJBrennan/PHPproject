        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="page-header">
			   ...
			   <center>
                <img src="images/london.jpg" class="img-rounded" width="800" height="200">
		       </center>
            </div>
            </div>
          </div>
      ...
      <div class="bs-docs-section">
        <div class="row">
          <div class="col-lg-12">
            <div class="page-header">
			<center>
              <h1 id="type"> London Information</h1>
			  </center>
            </div>
          </div>
        </div>
...
new jweather('UKXX0085','c','img/',false);
...
echo getFeed("http://feeds.bbci.co.uk/news/england/london/rss.xml");	
